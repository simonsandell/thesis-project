...
then
	...
	for filename in ./foutput/$1/L_bin/*$2*; do
	...
	for filename in ./foutput/$1/L_rs/*$2*; do
	...
	for filename in ./foutput/$1/L_en/*$2*; do
	...
	for filename in ./foutput/$1/L_mag/*$2*; do
	...
	for filename in ./foutput/$1/L_dbdt/*$2*; do
	...
	for filename in ./foutput/$1/L_xi/*$2*; do
