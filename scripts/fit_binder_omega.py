...
savePath = settings.foutput_path + "vsT/omega_fit"
savePathVar = settings.foutput_path + "vsT/omega_fit_var"
fileWriter.writeQuant(savePath+"omega_b_"+str(SKIP_N)+".dat", result_struct, [1, 2, 6]) # omega_bin
fileWriter.writeQuant(savePath+"omega_r_"+str(SKIP_N)+".dat", result_struct, [1, 3, 7]) # omega_rho
fileWriter.writeQuant(savePathVar+"var_omega_b_"+str(SKIP_N)+".dat", result_struct, [1, 4, 8]) # var_omega_bin
fileWriter.writeQuant(savePathVar+"var_omega_r_"+str(SKIP_N)+".dat", result_struct, [1, 5, 9]) # var_omega_rho
