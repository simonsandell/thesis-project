...
fileWriter.writeQuantNoDY(close_path+"closeness_nu.dat",nu_close,[0,1]);# closeness_nu vs omega
fileWriter.writeQuantNoDY(close_path+"closeness_eta.dat",eta_close,[0,1]);# closeness_eta vs omega
